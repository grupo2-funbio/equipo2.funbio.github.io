...
void loop() {
      ...
      if(i==0){
        ang_ref1 = accel_ang_y1;
        ang_ref2 = accel_ang_y2;
      }
      i++;
      
      ang_flex1 = accel_ang_y1 - ang_ref1;
      ang_flex2 = accel_ang_y2 - ang_ref2;
      
      //Obtener angulo final con filtro complementario
      ang_x1 = 0.98*(ang_x1_prev+(gx1/131)*dt) + 0.02*ang_flex1;
      ang_y1 = 0.98*(ang_y1_prev+(gy1/131)*dt) + 0.02*ang_flex1;
      ang_x2 = 0.98*(ang_x2_prev+(gx2/131)*dt) + 0.02*ang_flex2;
      ang_y2 = 0.98*(ang_y2_prev+(gy2/131)*dt) + 0.02*ang_flex2;
