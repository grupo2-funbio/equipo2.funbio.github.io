...
void loop() {
      ...
      if(i==0){
        ang_ref = accel_ang_y1;
        i++;
      }
      
      ang_flex= accel_ang_y1 - ang_ref;
      
      //Obtener angulo final con filtro complementario
      ang_x1 = 0.98*(ang_x1_prev+(gx1/131)*dt) + 0.02*accel_ang_x1;
      ang_y1 = 0.98*(ang_y1_prev+(gy1/131)*dt) + 0.02*ang_flex;
      ang_x2 = 0.98*(ang_x2_prev+(gx2/131)*dt) + 0.02*accel_ang_x2;
